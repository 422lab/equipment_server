...
@WebServlet(name = "UserChangeImage", value = "/userChangeImage")
public class UserChangeImageServlet extends BaseServlet {
    @Override
    protected void doGetOrPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            String image = tools.getParameter("image");
            if (account == null || password == null || image == null) {
                json.number("code", 1);
                return;
            }
